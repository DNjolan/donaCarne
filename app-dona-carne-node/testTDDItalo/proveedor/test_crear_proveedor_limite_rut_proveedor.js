...
describe('Proveedor', () => {
    describe('Manejar Proveedor', () => {
        it('Debería recibir un mensaje de error al superar el límite máximo de caracteres en Rut Proveedor', (done) => {
            chai.request(app)
                ...
                .send({                    
                    ...
                    'Logo': 'xd',
                    'Rut_proveedor': '1233213213213123213131324-k',    
                ...
                .end(function(err, res){
                    ...
                    expect(res.text).to.include("Fuera de rango para columna : 'Rut Proveedor'");
