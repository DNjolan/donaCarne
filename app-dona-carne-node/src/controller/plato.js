import { PlatoDao } from "../dao/plato";
...
export class PlatoController {
    ...
    postRegistrarPlato = async(req, res) => {
        ...
        try {
            const registro_cat = await PlatoDao.daoPostRegistrarPlato({ id_plato,Nombre_Plato,Valor,Descripcion,Empleado_id_emplado,Imagen,plato_orien_id_plato_orien,Tipo_plato_id_tipo_plato});
            if (registro_cat === 0) {
