...
@given(u'47 me dirigo a la pagina "{url}"')
...
@when(u'47 hago click en el botón iniciar sesión huesped "{enlace}"')
...
@when(u'47 ingresar datos de Huesped')
...
@then(u'47 ingreso a modificar plato "{url}"')
